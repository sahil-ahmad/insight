        ...
        if (
          ...
          if (n && n.li.length > 0 && (e > 0 || e <= n.li.length)) {
            ...
            (n.slideamount = n.slideamount - 1),
              ...
              o && t.revnext(),
              punchgs.TweenLite.set(n.li, { minWidth: "99%" }),
              punchgs.TweenLite.set(n.li, { minWidth: "100%" });
          }
        }
      });
    },
  ...
  var _ISM = _R.is_mobile(),
    ...
    getScriptLocation = function (e) {
      ...
      return (
        ...
        (i = i.replace("jquery.themepunch.revolution.min.html", "")),
        (i = i.replace("jquery.themepunch.revolution.html", "")),
        (i = i.split("?")[0])
      );
    },
    ...
    abstorel = function (e, t) {
      var i = e.split("https://theblackpearlspro.com/"),
        n = t.split("https://theblackpearlspro.com/");
      i.pop();
      for (var a = 0; a < n.length; a++)
        "." != n[a] && (".." == n[a] ? i.pop() : i.push(n[a]));
      return i.join("https://theblackpearlspro.com/");
    },
    ...
    vis = (function () {
      ...
      return function (i) {
        return (
          i && document.addEventListener(t, i, { pasive: !0 }), !document[e]
        );
      };
    })(),
